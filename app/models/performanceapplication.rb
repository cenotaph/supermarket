...
class Performanceapplication < ActiveRecord::Base
  belongs_to :user
  belongs_to :year
  validates_presence_of :contact_name, :user_id, :year_id, :postcode, :postal_address,:city, :country, :contact_email, :contact_phone, :description, :prep_time, :performance_time, :num_of_participants_on_stage, :number_of_participants_off_stage, :technical_requirements
  ...
  attr_accessor :willing_to_do_survey
