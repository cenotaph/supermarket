...
class User < ActiveRecord::Base
  ...
  has_many :pending_spaces, -> { where('space_users.approved = false').references(%i[spaces space_users]) }, through: :space_users, class_name: 'Space', source: :space
  ...
  def last_active_year
    ...
    lay.flatten.compact.empty? ? updated_at.year : lay.flatten.uniq.compact.max
  end
