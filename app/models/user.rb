class User < ActiveRecord::Base
  ...
  has_many :spaces, -> { where("space_users.approved = true").references(:spaces) }, through: :space_users
  has_many :pending_spaces, -> { where("space_users.approved = false").references(:spaces) }, through: :space_users
