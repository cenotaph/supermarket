...
class Admin::SpacesController < Admin::BaseController
  ...
  def comment
    ...
    @space.spacecomments << Spacecomment.new(params[:spacecomment].permit(%i[user_id application_id comment deny_field]))
