...
class Admin::PerformanceapplicationsController < Admin::BaseController
  ...
  def comment
    ...
    @performanceapplication.performanceapplicationcomments << Performanceapplicationcomment.new(params[:performanceapplicationcomment].permit(%i[user_id performanceapplication_id comment]))
