...
ActiveRecord::Schema.define(version: 20_181_127_161_414) do
  ...
  add_index 'activity_translations', %w[activity_id locale], name: 'unique_activity_translations_locales', unique: true, using: :btree
  ...
  add_index 'businesstype_translations', %w[businesstype_id locale], name: 'unique_businesstype_translations_locales', unique: true, using: :btree
  ...
  add_index 'exhibitionspacetype_translations', %w[exhibitionspacetype_id locale], name: 'unique_exhibitionspacetype_translations_locales', unique: true, using: :btree
  ...
  add_index 'menu_hierarchies', %w[ancestor_id descendant_id generations], name: 'menu_anc_desc_udx', unique: true, using: :btree
  ...
  add_index 'organisationtype_translations', %w[organisationtype_id locale], name: 'unique_organisationtype_translations_locales', unique: true, using: :btree
  ...
  add_index 'page_hierarchies', %w[ancestor_id descendant_id generations], name: 'page_anc_desc_udx', unique: true, using: :btree
  ...
  add_index 'page_subsites', %w[page_id subsite_id], name: 'index_page_subsites_on_page_id_and_subsite_id', unique: true, using: :btree
  ...
  add_index 'page_translations', %w[page_id locale], name: 'unique_page_translations_locales', unique: true, using: :btree
  ...
  add_index 'slugs', %w[name sequence sluggable_type scope], name: 'index_slugs_index_slugs_on_n_s_s_and_s', using: :btree
  ...
  add_index 'space_users', %w[space_id user_id], name: 'index_space_users_on_space_id_and_user_id', unique: true, using: :btree
